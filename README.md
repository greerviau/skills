...
- **[standards](skills/engineering/standards/SKILL.md)** — the shared house rules the other engineering skills enforce (documentation and plain-language style, naming and ubiquitous language, testing bias, branch hygiene, issue hygiene, PR/commit hygiene, and the interactive-vs-autonomous interaction contract), kept in one place so a change applies everywhere.
