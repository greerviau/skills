...
- **[pr-describe](skills/engineering/pr-describe/SKILL.md)** — writes an evergreen PR body (problem, intent, changes, testing, additional testing, regressions) with no AI attribution or volatile details; used standalone or as the body step of dev-workflow.
