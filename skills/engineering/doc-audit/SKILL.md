...
1. Identify what you touched: which functions, modules, or behaviors changed, and which comment lines the change adds. Enumerate the comments from the diff rather than from memory; the ones that break the form rules are the ones you don't remember writing.
